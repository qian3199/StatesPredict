...
from dytr_lstm import DyTR_LSTM
...
if __name__ == "__main__":
    ...
    # 数据路径
    result_path =f"E:/研究生学习/应用实践论文/DytrProject/result/model_{model_flag}_norm_{normalize}_num_epochs{num_epochs}_batch_size{batch_size}_{time.strftime('%Y%m%d_%H%M')}"
    checkpoint_path = f"{result_path}/checkpoints"  
    img_path = f"{result_path}/img"
    voyager_data_path=r"E:\研究生学习\应用实践论文\DytrProject\Dataset\real_base_control"
